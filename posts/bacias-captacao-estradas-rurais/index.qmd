...
::: {layout-ncol=2}
![Escavação de bacia de captação com retroescavadeira em margens de estrada rural](../../img/escavacao_bacia.jpeg){fig-alt="Escavação de bacia de captação" width="100%"}

![Montagem e acabamento de bacia de captação — compactação dos taludes e conexão com o sistema de drenagem](../../img/montagem_bacia.jpeg){fig-alt="Montagem de bacia de captação" width="100%"}
:::
...
::: {layout-ncol=3}
![Bacia de captação com acúmulo de água após evento de chuva](../../img/bacia_cheia_agua.jpeg){fig-alt="Bacia de captação cheia de água" width="100%"}

![Bacia armazenando água de escoamento superficial](../../img/bacia_com_agua.jpeg){fig-alt="Bacia com água armazenada" width="100%"}

![Bacia cheia após precipitação intensa](../../img/bacia_cheia_2.jpeg){fig-alt="Bacia cheia após chuva" width="100%"}
:::
...
::: {layout-ncol=2}
![Vista aérea das bacias de captação implantadas ao longo da malha viária do Campus Rural UFS](../../img/vista_aerea_bacias.jpeg){fig-alt="Vista aérea de bacias de captação" width="100%"}

![Vista aérea complementar mostrando distribuição das bacias conforme espaçamento de projeto](../../img/vista_area_bacias_2.jpeg){fig-alt="Vista aérea de bacias em operação" width="100%"}
:::
