...
image: "../../aulas/bioengenharia_de_solos/aulas/aula19_canaleta_verde/Canaleta-Verde.jpg"
lang: pt-BR
---
...
::: {layout-ncol=2}
![Escavação de canal escoadouro para condução controlada do escoamento superficial em área rural](../../img/escavacao_canal.jpeg){fig-alt="Escavação de canal escoadouro" width="100%"}

![Canal escoadouro em funcionamento durante evento de chuva — fluxo controlado e condução segura da enxurrada](../../img/canal_cheio_2.jpeg){fig-alt="Canal cheio em funcionamento" width="100%"}
:::
