...
::: {layout-ncol=2}
![Cordão de contorno em encosta — detalhe da interceptação do escoamento e retenção de sedimentos](../../img/cordao_contorno.jpeg){fig-alt="Cordão de contorno em campo"}

![Cordão de contorno com formação visível de micro-terraço por acúmulo de sedimento a montante](../../img/cordao_contorno_2.jpeg){fig-alt="Cordão de contorno com micro-terraço"}
:::
