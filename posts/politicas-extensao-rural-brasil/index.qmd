...
image: "../../img/extensao/Extensao (10).jpg"
lang: pt-BR
---

![Atividade de extensão rural em comunidade do Semiárido, onde a construção conjunta de conhecimento substitui a transmissão unilateral de pacotes tecnológicos](../../img/extensao/Extensao%20(15).jpg){fig-alt="Atividade presencial de extensão rural com agricultores familiares" width="80%"}
...
::: {layout-ncol=2}
![Interação entre extensionistas e produtores rurais em unidade demonstrativa](../../img/extensao/Extensao%20(3).jpg){fig-alt="Extensionistas e agricultores em atividade de campo"}

![Diálogo técnico em propriedade rural, reposicionando o agricultor como sujeito ativo do processo](../../img/extensao/Extensao%20(4).jpg){fig-alt="Diálogo técnico participativo em propriedade rural"}
:::
...
::: {layout-ncol=2}
![Visita técnica a propriedade rural como parte da operação em rede da ATER](../../img/extensao/visita%20(35).jpeg){fig-alt="Visita técnica a propriedade rural no Semiárido"}

![Acompanhamento de campo integrando diagnóstico participativo e monitoria contínua](../../img/extensao/visita%20(38).jpeg){fig-alt="Acompanhamento técnico contínuo em propriedade rural"}
:::
...
*Para saber mais sobre extensão rural e ATER, confira os posts sobre [Comunicação Rural e Metodologias Participativas](/posts/comunicacao-rural-metodologias-participativas/) e [ATER Digital e Difusão Tecnológica](/posts/ater-digital-inovacao-difusao-tecnologica/). Visite também nossas [publicações](/papers/) e [projetos](/#projetos).*
