...
image: "../../img/extensao/Extensao (1).jpg"
lang: pt-BR
---

![Roda de conversa entre extensionistas e agricultores, onde a comunicação dialógica substitui a transmissão unilateral de recomendações](../../img/extensao/Extensao%20(6).jpg){fig-alt="Roda de conversa entre extensionistas e produtores rurais" width="80%"}
...
::: {layout-ncol=2}
![Atividade de campo onde o extensionista atua como mediador e comunicador, não como prescritor](../../img/extensao/Extensao%20(9).jpg){fig-alt="Extensionista como mediador em atividade participativa"}

![Construção conjunta de conhecimento entre equipe técnica e produtores em propriedade rural](../../img/extensao/Extensao%20(11).jpg){fig-alt="Construção conjunta de conhecimento em propriedade rural"}
:::
...
::: {layout-ncol=2}
![Visita técnica participativa com observação em contexto e problematização guiada](../../img/extensao/visita%20(40).jpeg){fig-alt="Visita técnica participativa em propriedade rural"}

![Acompanhamento de campo com registro sistemático e escuta ativa](../../img/extensao/visita%20(42).jpeg){fig-alt="Acompanhamento de campo com escuta ativa e registro"}
:::
...
*Para saber mais sobre extensão rural, confira os posts sobre [Políticas de Extensão Rural no Brasil](/posts/politicas-extensao-rural-brasil/) e [ATER Digital e Difusão Tecnológica](/posts/ater-digital-inovacao-difusao-tecnologica/). Visite também nossas [publicações](/papers/) e [projetos](/#projetos).*
