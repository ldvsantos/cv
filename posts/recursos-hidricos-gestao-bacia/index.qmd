...
::: {layout-ncol=2}
![Vista aérea de bacias de captação implantadas como parte de sistema integrado de gestão hídrica em bacia hidrográfica rural](../../img/vista_aerea_bacias.jpeg){fig-alt="Vista aérea de bacias de captação para gestão hídrica" width="100%"}

![Bacia de captação com acúmulo de água após evento de chuva — retenção do escoamento superficial e infiltração no perfil do solo](../../img/bacia_cheia_agua.jpeg){fig-alt="Bacia de captação retendo água de escoamento" width="100%"}
:::
