...
|------------|--------|---------|
| **Mercantil** | Recurso como mercadoria | Mineração, agronegócio, energia |
| **Estatal** | Recurso como bem público regulado | Reservas, unidades de conservação |
| **Comunitária / tradicional** | Recurso como bem comum | Povos tradicionais, faxinais, extrativismo |
| **Privada-individual** | Recurso como propriedade | Imóvel rural, outorga de água |

: {.striped .hover}

### Concentração e desigualdade

- Estrutura fundiária concentrada (Gini fundiário no Brasil > 0,85)
- Acesso desigual à água, à terra e à infraestrutura ambiental
- Externalização de custos ambientais sobre territórios periféricos

![](../../../img/plantacao_sisal.jpeg){fig-alt="Apropriação produtiva e uso do solo" width="100%"}
:::

::: {.column width="50%"}
::: {.highlight-box}
**Conflitos socioambientais (Acselrad)**

Definição operacional:

> Disputa por **usos, sentidos e formas de apropriação** do território entre grupos com **assimetrias de poder**, atravessada por dimensões econômicas, ecológicas, culturais e simbólicas.

### Tipologia frequente no Brasil
...
![](https://upload.wikimedia.org/wikipedia/commons/e/eb/Brumadinho_dam_catastrophy_2.jpg){fig-alt="Danos da Catástrofe de Brumadinho" width="100%"}
:::
:::
:::
