...
![Cordão de contorno implantado em encosta experimental — interceptação do escoamento e retenção de sedimentos, reduzindo os fatores LS e P da RUSLE](../../../../img/cordao_contorno.jpeg){fig-align="center" width="70%"}

![Bacia de captação (barraginha) em operação após evento de chuva — redução do fator L e retenção de sedimentos](../../../../img/bacia_com_agua.jpeg){fig-align="center" width="70%"}
:::
:::
