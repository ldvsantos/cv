...
format: 
  revealjs:
    ...
    footer: "UEFS - Universidade Estadual de Feira de Santana | Tema 1 - Gestão da Inovação Tecnológica"
    slide-number: true
...
## Exemplo de patente universitária {.smaller-text}
...
::: {.column width="50%"}
![Patente de geocomposto vegetal  -  exemplo de output de PI universitária](../img/patente_geocomposto.jpg){width="100%"}
:::
:::
