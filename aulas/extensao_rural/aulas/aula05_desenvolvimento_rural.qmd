...
subtitle: "Desenvolvimento Rural<br>Antigas e Novas Abordagens"
author: "Luiz Diego Vidal Santos"
institute: "Universidade Federal de Sergipe (UFS)"
format:
  revealjs:
    logo: ../../assets/logo-uefs.webp
    footer: "UFS — Extensão e Sociologia Rural | Aula 05 — Desenvolvimento Rural"
    slide-number: true
...
- [1]{.circle} Conceito de Desenvolvimento
- [2]{.circle} Desenvolvimento como Liberdade (Sen)
- [3]{.circle} Revolução Verde e Consequências
- [4]{.circle} Novas Abordagens Sustentáveis (Sachs)
- [5]{.circle} Meios de Vida Sustentáveis
:::
...
Analisar as antigas e novas abordagens do desenvolvimento rural, da revolução verde às perspectivas de sustentabilidade e liberdade.
:::
:::
:::
...
![Produção de soja no Brasil — símbolo da Revolução Verde (CC-BY-SA 2.0, Wikimedia)](img/soja_producao_brasil.jpg){width="45%"}
