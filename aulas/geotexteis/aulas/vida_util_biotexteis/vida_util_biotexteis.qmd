...
::: {.column width="50%"}
![Tear artesanal para confecção de biotêxteis com fibras naturais](img/tear_fibras.jpg){width="100%"}

![Fibra de junco  -  matéria-prima para geotêxteis biodegradáveis](img/junco_fibra.jpg){width="100%"}
:::
:::
...
::: {.column width="45%"}
![Talude protegido com biotêxtil em campo](img/talude_biotextil.jpeg){width="100%"}
:::
:::
...
::: {.column width="50%"}
![Câmara de degradação para ensaios de biotêxteis](img/camara_degradacao.png){width="100%"}
...
::: {.column width="40%"}
![Coleta de amostras de biotêxtil em campo](img/coleta_campo.jpeg){width="100%"}

![Máquina universal de ensaio de tração](img/maquina_universal.png){width="100%"}
:::
:::

---

## Exercício  -  Entrega {.smaller-text}
