...
subtitle: "Exercício: Identificação de Feições e Padrões<br>Curso de Geografia"
author: "Luiz Diego Vidal Santos"
format:
  revealjs:
    logo: ../../../assets/logo-uefs.webp
    footer: "UEFS | Análise da Paisagem | Feições e Padrões"
    slide-number: true
...
Aplicar os fundamentos de sensoriamento remoto da Aula 15 em **exercício prático orientado**: acessar imagens Sentinel-2, gerar composições e índices, identificar feições e padrões de uso/cobertura na área de estudo.
:::
:::
:::
...
- Shapefile/GeoJSON da **área de estudo** (Aula 11)
- Slides da Aula 15 (referência)
:::
...
**Prazo:** próxima semana (antes da Aula 17)

> Este material será incorporado ao **dossiê** como segunda camada de evidência (após a cartografia temática da Aula 11).
:::
:::
:::
