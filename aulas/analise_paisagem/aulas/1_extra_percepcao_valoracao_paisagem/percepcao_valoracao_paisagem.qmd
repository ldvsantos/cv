...
<div style="text-align:center; margin:0.5em auto;">
  <iframe width="960" height="540" src="https://www.youtube.com/embed/t9N8TRV5FCQ" title="Roça de Toco / Coivara" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.3); max-width:100%;"></iframe>
  <p style="margin-top:0.5em; font-size:0.8em; color:#555;">Agricultura itinerante de corte e queima - sistema milenar dos povos tradicionais.</p>
</div>
```
...
```{=html}
<div style="text-align:center; margin:0.5em auto;">
  <iframe width="960" height="540" src="https://www.youtube.com/embed/igKi26bBSNs" title="Sistema Cabruca" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.3); max-width:100%;"></iframe>
  <p style="margin-top:0.5em; font-size:0.8em; color:#555;">O sistema cabruca no sul da Bahia: cacau cultivado sob a sombra da Mata Atlântica.</p>
</div>
```
...
```{=html}
<div style="text-align:center; margin:0.5em auto;">
  <iframe width="960" height="540" src="https://www.youtube.com/embed/b6xZd83WpMo" title="Fundo de Pasto" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.3); max-width:100%;"></iframe>
  <p style="margin-top:0.5em; font-size:0.8em; color:#555;">Comunidades tradicionais de Fundo de Pasto na Caatinga baiana.</p>
</div>
```
...
```{=html}
<div style="text-align:center; margin:0.5em auto;">
  <iframe width="960" height="540" src="https://www.youtube.com/embed/QkYQ4g3SE_k" title="Sistema Faxinal no Paraná" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.3); max-width:100%;"></iframe>
  <p style="margin-top:0.5em; font-size:0.8em; color:#555;">O sistema faxinal no Paraná, uso comum da terra sob a Floresta com Araucária.</p>
</div>
```
