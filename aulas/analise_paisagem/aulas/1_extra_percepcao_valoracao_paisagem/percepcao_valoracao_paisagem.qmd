...
::: {.columns}
::: {.column width="60%"}
A paisagem que analisamos com métricas, SIG e sensoriamento remoto é a **paisagem objetivada** â€” um mosaico de manchas, corredores e matriz quantificável por índices.
...
- **Sentidos** â€” visão, olfato, tato, audição
- **Cultura** â€” valores, crenças, tradições
- **Experiência** â€” história pessoal, memória
- **Atitude** â€” postura para com o ambiente (medo, admiração, indiferença)
...
|:------------------|:-------------------|
| **Percepção sensorial** | Inventários de campo devem registrar sons, cheiros, texturas â€” não apenas coordenadas |
...
::: {.callout-note}
## Para a prática
No trabalho de campo, pergunte aos moradores: *"O que você mais gosta nesta paisagem? O que mais teme?"* â€” essas respostas revelam valores que mapas e métricas não captam.
:::
...
- **Paisagem-marca** (*paysage-empreinte*): a paisagem como **registro** da ação humana sobre o território â€” cicatrizes de desmatamento, terraços agrícolas, padrões urbanos

- **Paisagem-matriz** (*paysage-matrice*): a paisagem como **condicionante** da ação futura â€” o relevo que impõe limites, o clima que define possibilidades, a forma urbana que orienta comportamentos

> A paisagem é ao mesmo tempo **produto** e **produtora** de relações sociais.

Essa formulação conecta:

- Ecologia â†’ paisagem como suporte biofísico (matriz)
- Geografia cultural â†’ paisagem como expressão social (marca)
:::
...
::: {.callout-tip}
## Referência
**BERQUE, A.** (1984). Paysage-empreinte, paysage-matrice. *L'Espace Géographique*, 13(1), 33â€“34.
:::
:::
:::
...
- A paisagem foi inventada como conceito estético pela **aristocracia mercantil** do Renascimento italiano (séc. XVâ€“XVI)
- Ver a paisagem pressupõe um **observador externo** com posição privilegiada â€” o olhar do proprietário, do viajante, do cartógrafo
...
- Mapeamos "vegetação nativa" e "pastagem" â€” categorias da ecologia
- Não mapeamos "terra do avô" ou "caminho da festa" â€” categorias da comunidade
...
::: {.callout-note}
No Brasil, a primeira paisagem cultural chancelada pelo IPHAN foi o **conjunto de feiras livres** do Vale do Jiquiriçá (BA) â€” paisagem cultural baiana!
:::
...
|:------------------|:-----------------|
| Tuan â€” Topofilia | â†’ Trabalho de Campo (Aula 25), Diagnóstico Integrado (Aula 20) |
| Berque â€” Marca/Matriz | â†’ Geossistema (Aula 03), Planejamento Territorial (Aula 21) |
| Cosgrove â€” Paisagem e poder | â†’ Matriz de Evidências (Aula 10), Zoneamentos (Aula 22) |
| Paisagem cultural (IPHAN) | â†’ Legislação Ambiental e Paisagística |
