...
subtitle: "Exercício Aplicado: Interpretação Crítica de Indicadores<br>Curso de Geografia"
author: "Luiz Diego Vidal Santos"
format:
  revealjs:
    logo: ../../../assets/logo-uefs.webp
    footer: "UEFS | Análise da Paisagem | Indicadores"
    slide-number: true
...
|---------|----------|---------|
| **PC** | Probabilidade de conectividade | PC = Σᵢ Σⱼ (aᵢ · aⱼ · p*_ij) / A_L² |
| **IIC** | Índice integral de conectividade | IIC = Σᵢ Σⱼ [aᵢ · aⱼ / (1 + nl_ij)] / A_L² |
...
⚠️ *Os dados abaixo são um cenário didático hipotético, criado para fins de exercício.*
...
MPS_caatinga = 600 / 12 = 50 ha/mancha

### Densidade de bordas (ED)

ED_caatinga = 42.000 m / 5.000 ha = 8,4 m/ha
...
::: {.column width="50%"}
::: {.info-box}
**Modelo de síntese para o dossiê** ⚠️ *cenário didático hipotético*
...
- **Aula 20** (06/05): Unidades de paisagem  -  delimitação e caracterização
- **Aula 20** (06/05): Diagnóstico integrado  -  pressões, conflitos, vulnerabilidades
:::
:::
:::
