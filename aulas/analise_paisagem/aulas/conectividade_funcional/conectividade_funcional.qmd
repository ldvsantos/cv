...
1. Medir **diferenciação genética** ($F_{ST}$) entre populações em manchas distintas
...
> Se distância de custo prediz $F_{ST}$ melhor que distância euclidiana → **a matriz importa para o fluxo gênico**
:::
