...
> Se $NP_{real}$ >> $NP_{neutro}$ → processo de fragmentação ativo  
> Se $AI_{real}$ >> $AI_{neutro}$ → autocorrelação espacial (sucessão, legislação)
:::
...
Em paisagens binárias aleatórias (With & King, 1997), o **limiar de percolação** ocorre em $PLAND \approx 59{,}28\%$.
