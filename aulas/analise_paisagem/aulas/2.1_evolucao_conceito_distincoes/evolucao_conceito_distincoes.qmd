...
<tr><td style="text-align:center">1960s</td><td><strong>Sochava</strong> (URSS)</td><td><strong>Geossistema</strong> — sistema aberto: fluxos de energia/matéria</td></tr>
...
::: {.columns}
::: {.column width="50%"}
![Milton Santos (1926-2001)](img/milton_santos.jpg){width="50%" fig-align="center"}
...
- **Espaço geográfico** = Forma + Conteúdo (Dinâmico, vivo, relações sociais e dinâmicas políticas/econômicas atuando agindo no presente).
...
## Milton Santos: aplicação e bibliografia {.smaller-text}
...
::: {.highlight-box}
**1. O Casarão Antigo**  
A **Paisagem** é o casarão no centro (arquitetura velha, "trabalho morto"). O **Espaço** é o que acontece lá no presente: a ocupação por movimentos de moradia ou a retenção por capital imobiliário (pulsão viva).

**2. O Jornal de Harry Potter (O Profeta Diário)**  
O **papel impresso e recortado** (a estrutura material estática) é a **Paisagem**. Porém, as **fotografias se movem e os personagens interagem** no papel. Essa ação contínua acontecendo *dentro* e *através* daquela materialidade prévia é o **Espaço** (Forma + Conteúdo e dinâmica viva).
:::
:::
::: {.column width="35%"}
![O Espaço é o movimento habitando a Forma](https://media.tenor.com/h9f9K2FvAooAAAAM/harry-potter-daily-prophet.gif){width="100%" fig-align="center"}
:::
:::

### Onde Milton Santos aborda isso
...
::: {.columns}
::: {.column width="50%"}
### Leitura obrigatória — próxima aula
