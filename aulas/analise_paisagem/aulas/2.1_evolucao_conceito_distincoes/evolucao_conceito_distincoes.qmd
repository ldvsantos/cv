...
### Exemplo de Aplicação (O Casarão Antigo)

::: {.highlight-box}
A **Paisagem** é um casarão abandonado no centro da cidade (arquitetura velha, "trabalho morto"). O **Espaço** é o que acontece ali no presente (conteúdo e pulsão viva): pode estar ocupado por movimentos por moradia, ou retido por capital imobiliário (especulação). A forma física herdada sofre ação e pulsa junto da dinâmica social atual.
:::
