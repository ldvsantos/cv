...
subtitle: "Matriz de Evidências e Síntese Descritivo-Interpretativa<br>Curso de Geografia"
author: "Luiz Diego Vidal Santos"
format:
  revealjs:
    logo: ../../../assets/logo-uefs.webp
    footer: "UEFS | Análise da Paisagem | Matriz de Evidências"
    slide-number: true
...
### Exemplo de interpretação ⚠️ *cenário didático hipotético*
...
- Síntese preliminar (Aula 13): **1-2 páginas** + matriz de evidências
...
1. **Preencha a matriz de evidências** (15 min)
   - Use os dados da Aula 11 (mapa de uso/cobertura, MDE)
   - Use a interpretação visual da Aula 12
...
- **Prazo:** até antes da 1ª Avaliação (15/04)
...
7. **Revisão**  -  4 blocos de conteúdo para a 1ª Avaliação (15/04)
:::
