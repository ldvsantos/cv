...
subtitle: "Diagnóstico Integrado: Pressões, Conflitos e Potencialidades<br>Curso de Geografia"
author: "Luiz Diego Vidal Santos"
format:
  revealjs:
    logo: ../../../assets/logo-uefs.webp
    footer: "UEFS | Análise da Paisagem | Diagnóstico Integrado"
    slide-number: true
...
::: {.column width="50%"}
::: {.highlight-box}
**Diagnóstico ≠ descrição** ⚠️ *dados do cenário didático*
...
|---------|----------|-------|
| **Desmatamento** | Redução de PLAND ao longo da série temporal | MapBiomas, Aula 18 |
| **Fragmentação** | NP alto, MPS baixo, ENN alto | Métricas, Aula 19 |
| **Erosão** | Solo exposto em encostas, cicatrizes | Imagem, NDVI, campo |
| **Sobrepastejo** | Pastagem com NDVI < 0,2, sinais de compactação | Sentinel-2, Aula 16 |
| **Supressão de APP** | Mata ciliar < 30 m, ausência de vegetação ripária | Interpretação visual, Aula 12 |
...
::: {.column width="50%"}
::: {.highlight-box}
**Exemplo de síntese** ⚠️ *cenário didático hipotético*
...
**Prazo:** até Aula 21 (13/05)

### Próximas aulas

- **Aula 21** (13/05): Planejamento territorial  -  diretrizes e prioridades
- **Aula 22** (13/05): Zoneamentos aplicados  -  exercício de proposição
:::
:::
:::
