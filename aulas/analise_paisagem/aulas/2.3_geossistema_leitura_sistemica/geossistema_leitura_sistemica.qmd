...
subtitle: "Abordagens Integradoras:<br>Geossistema e Leitura Sistêmica<br>Curso de Geografia"
author: "Luiz Diego Vidal Santos"
format:
  revealjs:
    logo: ../../../assets/logo-uefs.webp
    footer: "UEFS | Análise da Paisagem | Geossistema e Leitura Sistêmica"
    slide-number: true
...
## Bertalanffy e a Teoria Geral dos Sistemas {.smaller-text transition="concave"}

::: {.columns}
::: {.column width="50%"}
### Ludwig von Bertalanffy (1901–1972)

- Biólogo austríaco, propôs a **Teoria Geral dos Sistemas (TGS)** em 1950
- Objetivo: encontrar **princípios universais** válidos para qualquer sistema, seja biológico, físico ou social
- Rompeu com o reducionismo: o todo **não é igual** à soma das partes

### Conceitos-chave da TGS

| Conceito | Significado |
|----------|------------|
| **Totalidade** | O todo não se reduz à soma das partes |
| **Isomorfismo** | Leis estruturais comuns a sistemas de natureza distinta |
| **Equifinalidade** | Estados finais semelhantes a partir de condições iniciais diferentes |
| **Homeostase** | Tendência do sistema a manter-se em equilíbrio dinâmico |
| **Hierarquia** | Sistemas contêm subsistemas organizados em níveis |
...
::: {.column width="50%"}
::: {.highlight-box}
**Por que a TGS chegou à Geografia?**

A TGS ofereceu uma **linguagem transdisciplinar** que permitiu integrar o que antes era estudado separadamente:

- Climatologia + Geomorfologia + Hidrologia + Biogeografia
- Natureza + Sociedade

Isso permitiu que geógrafos como **Sochava (1963)** e **Bertrand (1968)** construíssem o conceito de **geossistema**, uma unidade territorial com componentes em interação sistêmica.

> *"A paisagem não é um mosaico de elementos justapostos, mas um sistema de relações."*  
> (inspirado em Bertalanffy)
...
::: {.info-box}
**Cadeia do pensamento sistêmico na Geografia:** TGS (Bertalanffy, 1950) → Geossistema soviético (Sochava, 1963) → Geossistema francês (Bertrand, 1968) → Complexidade e irreversibilidade (Prigogine, 1977/1996) → Análise da paisagem contemporânea
:::

---

## Prigogine e *O Fim das Certezas* {.smaller-text transition="concave"}

::: {.columns}
::: {.column width="50%"}
### Ilya Prigogine (1917–2003)

- Físico-químico belga de origem russa
- **Nobel de Química** (1977) por trabalhos sobre **estruturas dissipativas**
- Obra-síntese: ***O Fim das Certezas*** (1996)  -  propõe que a natureza é fundamentalmente **irreversível** e **imprevisível** a longo prazo

### Da TGS à complexidade

| Bertalanffy (TGS) | Prigogine (Complexidade) |
|---|---|
| Equilíbrio dinâmico | Longe do equilíbrio |
| Ordem pré-existente | Ordem emerge do caos |
| Retroalimentação estável | Bifurcações e rupturas |
| Previsibilidade | Irreversibilidade temporal |

: {.striped .hover}

Bertalanffy explicou **como sistemas funcionam**; Prigogine explicou **por que mudam de estado**.
:::

::: {.column width="50%"}
::: {.highlight-box}
**Conceitos-chave para a paisagem**

**1. Estruturas dissipativas**  
Sistemas abertos longe do equilíbrio criam ordem a partir do fluxo de energia. A paisagem é uma estrutura dissipativa: mantém organização enquanto recebe energia solar e precipitação.

**2. Irreversibilidade**  
Processos na paisagem têm **seta do tempo**: uma voçoroca não retorna espontaneamente a uma encosta estável. Desmatamento → erosão → assoreamento não é reversível apenas replantando.

**3. Bifurcações (limiares)**  
Existem pontos críticos onde o sistema "escolhe" um novo estado. Ex.: cobertura vegetal abaixo de ~30% → colapso da conectividade (limiar de percolação).

**4. Auto-organização**  
Padrões espaciais (mosaico vegetação-solo-uso) emergem de interações locais sem planejamento central. Manchas de caatinga se organizam conforme topografia e disponibilidade hídrica.
:::
:::
:::

::: {.info-box}
**Na prática da disciplina:** quando identificamos **limiares de fragmentação**, **resiliência de paisagens** e **trajetórias irreversíveis de degradação**, estamos aplicando Prigogine, mesmo sem citá-lo diretamente.
:::
...
3. Introduziu a ideia de **limiar**: ultrapassar certos limites leva o sistema a um novo estado (por vezes irreversível)  -  conceito que dialoga com as **bifurcações** de Prigogine
:::
:::
:::
