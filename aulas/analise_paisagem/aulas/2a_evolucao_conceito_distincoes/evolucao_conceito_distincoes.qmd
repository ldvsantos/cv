...
::: {.info-box}
**Da Aula 03  -  o que já sabemos sobre Humboldt:**

- *Landschaft* = **fisionomia regional**, totalidade perceptível
- Método do **"Empirismo Raciocinado"**: observação + intuição + síntese
- A paisagem como resultado da **interação** entre clima, relevo, vegetação e cultura
...
> *"A ecologia da paisagem estuda a estrutura, a função e as mudanças do mosaico de ecossistemas em escala paisagística."*  -  Troll (adaptado)
:::
:::
:::
...
> *"A paisagem é a porção da Terra que é compreendida pelo olhar."*  -  Berque (adaptado)
...
> *"Fazer a análise da paisagem é, ao mesmo tempo, um exercício de síntese."*  -  Monteiro (adaptado)
:::
:::
:::
