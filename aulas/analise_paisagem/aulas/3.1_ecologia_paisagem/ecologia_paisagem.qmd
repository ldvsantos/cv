...
- [7]{.circle} Discussão da leitura (Metzger, 2001) — *após a leitura*
- [8]{.circle} Atividade prática: identificação em mosaico
:::
...
# [8  -  ATIVIDADE PRÁTICA]{.section-header}

## Exercício: identificação no mosaico {.smaller-text .scrollable}
...
> **Diagnóstico visual** — refinado com dados quantitativos nas aulas futuras.
:::
:::
:::
