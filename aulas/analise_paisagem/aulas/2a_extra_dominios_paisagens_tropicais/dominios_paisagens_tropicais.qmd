...
::: {.columns}
::: {.column width="60%"}
O conceito de **geossistema** surgiu na escola soviética com Viktor Sochava (1963), que propôs tratar a paisagem como um sistema natural total â€” integrando litosfera, atmosfera, hidrosfera e biosfera.
...
> *"A paisagem não é a simples adição de elementos geográficos disparatados â€” é, em uma determinada porção do espaço, o resultado da combinação dinâmica, portanto instável, de elementos físicos, biológicos e antrópicos."*
>
> â€” Bertrand (1971)
:::
...
**BERTRAND, G.** (1971). Paysage et géographie physique globale: esquisse méthodologique. *Rev. Géogr. Pyrénées SO*, **39**(3), 249â€“272.
...
| II | Domínio | 10â¶â€“10â· ha | Domínio das caatingas |
| III | Região natural | 10âµâ€“10â¶ ha | Depressão sertaneja |
| IV | **Geossistema** | 10³â€“10âµ ha | Pediplano cristalino com caatinga arbórea |
| V | Geofácies | 10¹â€“10³ ha | Vertente com solo raso e vegetação aberta |
| VI | Geótopo | < 10¹ ha | Afloramento rochoso com liquens |

: Taxonomia hierárquica de Bertrand (1971). {.striped .hover}

::: {.callout-note}
O **geossistema** é a unidade central de análise â€” escala compatível com bacias de 3ªâ€“5ª ordem, onde a interação entre componentes é mais perceptível pela ação humana.
:::
...
A retroalimentação entre ação antrópica e potencial ecológico é o que diferencia o geossistema de um simples ecossistema â€” a **sociedade** é vista como componente interno, não externo.
...
- O conceito de **derivações antropogênicas** â€” transformações impostas pela sociedade sobre o sistema natural
...
1. **Amazônico** â€” terras baixas florestadas
2. **Cerrado** â€” chapadões tropicais com cerrados e florestas-galeria
3. **Mares de Morros** â€” relevo mamelonizado com Mata Atlântica
4. **Caatingas** â€” depressões interplanálticas semiáridas
5. **Araucárias** â€” planalto meridional com floresta mista
...
::: {.callout-important}
O 3º nível â€” **fisiologia da paisagem** â€” corresponde à dinâmica dos processos atuais e é o mais suscetível às derivações antropogênicas de Monteiro.
:::
...
- Depressões interplanálticas entre 200â€“500 m
...
- Bacia do Paraguaçu: transição Caatingaâ€“Mata Atlântica
...
2. Sobreponha mapas de solo e cobertura vegetal â†’ **estrutura superficial** (2º nível)
3. Analise séries NDVI (12 meses) â†’ **fisiologia** (3º nível)
4. Identifique qual **domínio** ou **faixa de transição** sua área representa
:::
:::

# [4  -  SÍNTESE E CONEXÃ•ES]{.section-header}

## Bertrand Ã— Monteiro Ã— Ab'Sáber {.smaller-text}
...
| **Escala** | 10³â€“10âµ ha | 10â´â€“10â¶ ha | 10â¶â€“10â· ha |
| **ÃŠnfase** | Taxonomia + ação antrópica | Derivações + clima | Geomorfologia + paleoclima |
...
- Geossistema â†’ geofácies â†’ geótopo de Bertrand
...
- **BERTRAND, G.** (1971). Paysage et géographie physique globale. *Rev. Géogr. Pyrénées SO*, 39(3), 249â€“272.
- **MONTEIRO, C.A.F.** (2000). *Geossistemas: a história de uma procura*. São Paulo: Contexto.
- **AB'SÁBER, A.N.** (2003). *Os domínios de natureza no Brasil*. São Paulo: Ateliê Editorial.
- **METZGER, J.P.** (2001). O que é ecologia de paisagens? *Biota Neotropica*, 1(1), 1â€“9.