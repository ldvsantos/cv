...
flowchart TD
    ...
    B --> |"Dicotômica<br/>(0/1)"| D["Regressão<br/>Logística Binária"]:::result
    B --> |"Politômica<br/>nominal"| E["Regressão<br/>Multinomial"]:::result
    B --> |"Contagem"| F["Regressão<br/>de Poisson"]:::leaf

    C --> |"1 VI"| G["Regressão Linear<br/>Simples"]:::leaf
    C --> |"≥ 2 VIs"| H["Regressão Linear<br/>Múltipla"]:::result
