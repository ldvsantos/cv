---
title: "Regressão"
subtitle: "Aula 14 — Modelos de Regressão Linear e Múltipla<br>Análise de Dados Ambientais"
...
![Plantio direto em área agrícola](foto_plantio_direto.jpg){width="50%"}
...
![Regressão linear simples com resíduos e IC 95%](fig_01_regressao_linear.png)
...
![Painel de diagnósticos da regressão](fig_02_diagnosticos_regressao.png)
...
![Diagnóstico de multicolinearidade (VIF)](fig_05_vif_multicolinearidade.png)
