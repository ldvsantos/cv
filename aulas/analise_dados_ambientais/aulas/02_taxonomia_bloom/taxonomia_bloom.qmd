...
::: {.bloom-pyramid}
::: {.bp-row .bp-1}
[6]{.bp-num} **CRIAR** <small>Gerar algo novo e original</small>
:::
::: {.bp-row .bp-2}
[5]{.bp-num} **AVALIAR** <small>Julgar com critérios e padrões</small>
:::
::: {.bp-row .bp-3}
[4]{.bp-num} **ANALISAR** <small>Decompor e identificar relações</small>
:::
::: {.bp-row .bp-4}
[3]{.bp-num} **APLICAR** <small>Usar procedimento em situação conhecida</small>
:::
::: {.bp-row .bp-5}
[2]{.bp-num} **ENTENDER** <small>Construir significado</small>
:::
::: {.bp-row .bp-6}
[1]{.bp-num} **LEMBRAR** <small>Recuperar informação da memória</small>
:::
:::

::: {.info-box}
Hierarquia cumulativa: cada nível superior pressupõe o domínio dos anteriores. As habilidades de **ordem superior** (HOTS, níveis 4–6) sustentam-se sobre as de **ordem inferior** (LOTS, níveis 1–3).
:::
...
## Níveis 1 a 3: Habilidades de Ordem Inferior (LOTS) {.smaller-text .scrollable}
...
## Níveis 4 a 6: Habilidades de Ordem Superior (HOTS) {.smaller-text .scrollable}
...
## Guia Rápido de Verbos por Nível {.smaller-text .scrollable}
...
## Exemplo Prático: Erosão {.smaller-text .scrollable}
...
## Alinhamento Objetivo–Método–Análise {.smaller-text .scrollable}
...
## Erros Comuns e Correções {.smaller-text .scrollable}
...
## Resumo: Dimensão do Conhecimento {.smaller-text .scrollable}
