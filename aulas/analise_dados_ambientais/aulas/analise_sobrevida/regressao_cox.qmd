...
Após a regressão de Cox, pode-se plotar **curvas de sobrevida ajustadas** pelas covariáveis do modelo.
...
- Linha vertical em **HR = 1** (referência)
- Pontos → HR estimado
- Barras horizontais → IC 95%
- Se IC cruza a linha 1 → **não significativo**
- Se IC está todo à direita → **fator de risco**
- Se IC está todo à esquerda → **fator de proteção**
:::

::: {.info-box}
**Figuras essenciais no artigo:**

1. Curva de Kaplan-Meier por grupos
2. Forest Plot da regressão de Cox multivariada
:::
