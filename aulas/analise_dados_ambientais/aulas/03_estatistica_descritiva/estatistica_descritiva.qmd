...
## Resumo de Tendência Central {.smaller-text}
...
## Conceito de Variância {.smaller-text}
...
## Cálculo da Variância {.smaller-text}
...
## Resultado: Variância e Desvio-Padrão {.smaller-text}
...
## O que é o Escore Z? {.smaller-text}
...
## Escore Z na Prática {.smaller-text}
...
## O que é o Intervalo de Confiança? {.smaller-text}
...
## Visualização do IC {.smaller-text}
