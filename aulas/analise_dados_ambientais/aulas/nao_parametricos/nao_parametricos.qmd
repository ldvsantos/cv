...
![Pesquisa agrícola em campo](foto_pesquisa_agricola.jpg){width="50%"}
...
![Teste de Mann-Whitney: dados brutos, ranking e soma de postos](fig_01_mann_whitney.png)
...
![Kruskal-Wallis: comparação entre biomas](fig_02_kruskal_wallis.png)
...
![Wilcoxon Signed-Rank: dados pareados pré-pós](fig_03_wilcoxon_pareado.png)
...
![Teste de Friedman: trajetórias de medidas repetidas](fig_04_friedman.png)
