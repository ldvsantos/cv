...
![Série temporal de precipitação com anomalias destacadas](fig_01_serie_anomalias.png)
...
![Estação pluviométrica de monitoramento](foto_estacao_pluviometrica.jpg){width="45%"}
...
![Decomposição STL: série original, tendência, sazonalidade e resíduos](fig_02_decomposicao_stl.png)
...
![Método IQR: boxplot com limites e outliers](fig_03_iqr_boxplot.png)
...
![Isolation Forest: conceito e distribuição de scores](fig_04_isolation_forest.png)
...
![Comparação de métodos de detecção de anomalias](fig_05_comparacao_metodos.png)
