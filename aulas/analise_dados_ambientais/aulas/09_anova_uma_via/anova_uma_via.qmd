...
::: {.info-box}
**O risco:** Cada teste estatístico carrega 5% de chance de erro (significância alfa = 0,05). Se você fizer 3, 6 ou 10 comparações separadas, o risco total dispara!
:::
...
::: {.box}
**SQ~T~ = 35,56** &emsp;|&emsp; **SQ~M~ = 20,26** &emsp;|&emsp; **SQ~R~ = 15,30**
:::
