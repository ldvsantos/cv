...
![Tipos de correlação: positiva, negativa, nula e não-linear](fig_01_tipos_correlacao.png)
...
![Escala de magnitude da correlação (-1 a +1)](fig_03_escala_correlacao.png)
...
![Comparação visual entre r e r² (tamanho de efeito)](fig_02_tamanho_efeito.png)
...
![Coleta de dados em campo](foto_coleta_solo_campo.jpg){width="60%"}
