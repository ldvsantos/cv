...
![Canal Escoadouro - Teoria](img/slide01_img01.png){fig-align="center" width="50%"}
...
## Registros de campo: canais escoadouros {.smaller-text}

::: {.columns}
::: {.column width="33%"}

![Escavação de canal escoadouro em área rural — conformação da seção trapezoidal com maquinário](../../../../img/escavacao_canal.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="33%"}

![Escavação e abertura de canal para condução do escoamento — etapa de implantação](../../../../img/escavacal_canal.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="33%"}

![Canal escoadouro em funcionamento durante evento de chuva — fluxo controlado e condução segura](../../../../img/canal_cheio_2.jpeg){fig-align="center" width="100%"}
:::
:::
