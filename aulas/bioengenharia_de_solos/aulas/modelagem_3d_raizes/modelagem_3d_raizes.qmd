...
::: {.column width="50%"}
![Exemplo de foto de campo bem executada: raízes de vetiver expostas com escala métrica visível e iluminação uniforme](img/raizes_vetiver/vetiver_escala.png){fig-alt="Foto de campo com escala métrica" width="100%"}
...
::: {.column width="50%"}
![Corte transversal do sistema radicular de vetiver para cálculo do RAR  -  cada seção horizontal revela a distribuição de raízes naquela profundidade](img/raizes_vetiver/vetiver_corte_rar.jpg){fig-alt="Corte transversal para cálculo de RAR" width="100%"}
:::
:::
