...
flowchart TD
    ...
    style I fill:#2135A6,color:#fff
    style J fill:#586BA6,color:#2135A6
    style K fill:#586BA6,color:#2135A6
    style L fill:#2E7D32,color:#fff
    style M fill:#27368C,color:#fff
    style N fill:#27368C,color:#fff
```
:::
:::
...
flowchart TD
    ...
    style D fill:#586BA6,color:#2135A6
    style E fill:#586BA6,color:#2135A6
    style F fill:#586BA6,color:#2135A6
...
## Registro fotográfico da implantação {.smaller-text}

::: {.columns}
::: {.column width="50%"}

### Escavação e montagem em campo

![Escavação de bacia de captação com retroescavadeira — conformação do reservatório nas margens da estrada rural](../../../../img/escavacao_bacia.jpeg){fig-align="center" width="100%"}

![Etapa complementar de escavação — ajuste da geometria e profundidade da bacia](../../../../img/escavacao_bacia%20(2).jpeg){fig-align="center" width="100%"}
:::

::: {.column width="50%"}

![Montagem e acabamento da bacia de captação — compactação dos taludes e conexão com o canal lateral](../../../../img/montagem_bacia.jpeg){fig-align="center" width="100%"}

::: {.highlight-box}
**Sequência construtiva real:** as fotografias documentam as etapas de escavação com retroescavadeira, conformação do reservatório e acabamento dos taludes internos, conforme o protocolo de Griebeler (2002).
:::
:::
:::
...
## Bacias em operação — registros de campo {.smaller-text}

::: {.columns}
::: {.column width="33%"}

![Bacia de captação com acúmulo de água após evento de chuva — retenção e infiltração em progresso](../../../../img/bacia_cheia_agua.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="33%"}

![Bacia com água armazenada — demonstrando a capacidade de retenção do reservatório escavado](../../../../img/bacia_com_agua.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="33%"}

![Bacia cheia após precipitação intensa — o nível d'água indica o volume de escoamento captado](../../../../img/bacia_cheia_2.jpeg){fig-align="center" width="100%"}
:::
:::

::: {.highlight-box}
**Evidência de funcionamento:** as imagens mostram bacias em diferentes estágios de captação, comprovando a eficiência na retenção do escoamento superficial. O tempo de permanência da água na bacia favorece a **infiltração** e a **deposição gravitacional de sedimentos**.
:::
...
## Vista aérea do sistema de bacias {.smaller-text}

::: {.columns}
::: {.column width="50%"}

![Vista aérea do conjunto de bacias de captação implantadas — distribuição ao longo da malha viária rural](../../../../img/vista_aerea_bacias.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="50%"}

![Vista aérea complementar — bacias dispostas conforme o espaçamento de projeto e a declividade do terreno](../../../../img/vista_area_bacias_2.jpeg){fig-align="center" width="100%"}
:::
:::

::: {.info-box}
**Monitoramento por drone:** as imagens aéreas permitem avaliar a distribuição espacial das bacias, verificar o estado de conservação dos taludes e identificar trechos que necessitam de manutenção ou implantação de novas unidades.
:::
...
## {.center background-color="#2135A6" background-image="../../../assets/fundo.png" background-size="auto 100%" background-position="left center"}
