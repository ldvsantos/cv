...
### Comparação funcional {style="font-size: 0.85em;"}
...
### Quando utilizar a canaleta verde? {style="font-size: 0.85em;"}

::: {.info-box style="font-size: 0.6em;"}
...
::: {.highlight-box style="font-size: 0.6em;"}
...
flowchart LR
    ...
    style B fill:#2135A6,color:#fff
    style C fill:#586BA6,color:#2135A6
