...
::: {.column width="45%"}
![Talude em área de campo — Sergipe](img/talude_campo_02.jpg){width="100%"}
:::
:::
...
![Talude com exposição de horizonte do solo em campo](img/talude_campo_01.jpg){fig-align="center" width="65%"}
