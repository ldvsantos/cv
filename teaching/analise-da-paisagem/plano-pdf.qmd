...
{\normalsize Departamento de Tecnologia} \\[2pt]
...
\hline
\textbf{Período} & 25/02/2026 a 10/06/2026 \\
\hline
...
\hline
2º & 18/03 & Evolução do conceito e distinções; abordagens integradoras: geossistema e leitura sistêmica. \\
\hline
3º & 25/03 & Ecologia da paisagem (matriz--mancha--corredor); escala, padrão e processo. \\
\hline
4º & 01/04 & Fluxos, fragmentação, resiliência e vulnerabilidade; cartografia temática aplicada. \\
\hline
5º & 08/04 & Exercício de delimitação da área de estudo; interpretação visual da paisagem. \\
\hline
\textbf{6º} & \textbf{15/04} & \textbf{Matriz de evidências e síntese. 1ª AVALIAÇÃO (Teórica I --- individual).} \\
\hline
7º & 22/04 & Sensoriamento remoto I: fundamentos operacionais; exercício de feições e padrões. \\
\hline
8º & 29/04 & Sensoriamento remoto II: mudanças e trajetórias; produto parcial de mudanças. \\
\hline
9º & 06/05 & Métricas e indicadores; unidades de paisagem e diagnóstico integrado. \\
\hline
10º & 13/05 & Planejamento territorial e zoneamentos aplicados; exercício orientado. \\
\hline
\textbf{11º} & \textbf{20/05} & \textbf{2ª AVALIAÇÃO (Prática I --- em grupo): \textit{Serious Game/Desafio}.} \\
\hline
12º & 27/05 & Atividade de campo; organização das evidências. \\
\hline
\textbf{13º} & \textbf{03/06} & \textbf{3ª AVALIAÇÃO (Prática II --- individual): Relatório Técnico de Campo.} \\
\hline
\textbf{14º} & \textbf{10/06} & \textbf{4ª AVALIAÇÃO (Teórica II --- individual): integração de métodos e tomada de decisão.} \\
\hline
\end{longtable}

\vspace{0.2cm}
\noindent\textit{Todas as aulas ocorrem no turno da manhã, das 07h30 às 11h30 (4 h por encontro). Período: 25/02 a 10/06.}
