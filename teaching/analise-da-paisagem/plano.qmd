...
| 3º | 18/03 | Evolução do conceito e distinções (espaço, território, ambiente). |
| 4º | 25/03 | Percepção e valoração da paisagem; domínios de paisagens tropicais. |
| 5º | 01/04 | Abordagens integradoras: geossistema e leitura sistêmica; ecologia da paisagem (matriz–mancha–corredor, conectividade). |
| 6º | 08/04 | Escala, padrão e processo: escalas espaço-temporais; fluxos, fragmentação, bordas e resiliência; cartografia temática e interpretação visual. |
| **7º** | **15/04** | **Exercício de delimitação da área de estudo; matriz de evidências e síntese descritivo-interpretativa. 1ª AVALIAÇÃO (TEÓRICA I – individual): fundamentos do conceito de paisagem, abordagens, escala/dinâmica, cartografia e interpretação visual.** |
...
| 10º | 13/05 | Métricas e indicadores de paisagem (heterogeneidade, fragmentação, conectividade); unidades de paisagem e diagnóstico integrado: delimitação, caracterização, pressões, conflitos, vulnerabilidades e potencialidades. |
| 11º | 20/05 | Planejamento territorial e zoneamentos aplicados: diretrizes, prioridades (conservação, conectividade, recuperação); exercício orientado. |
| **12º** | **27/05** | **2ª AVALIAÇÃO (PRÁTICA I – em grupo): *Serious Game/Desafio* (diagnóstico \+ diretrizes \+ justificativa técnica \+ defesa e entrega).** |
| 13º | 03/06 | Atividade de campo: observação sistemática, registros (fotos/croquis), identificação de unidades/processos; organização das evidências. |
| **14º** | **10/06** | **3ª AVALIAÇÃO (PRÁTICA II – individual): entrega do Relatório Técnico de Campo (com evidências e síntese). 4ª AVALIAÇÃO (TEÓRICA II – individual): integração de métodos e tomada de decisão em análise/planejamento da paisagem.** |
