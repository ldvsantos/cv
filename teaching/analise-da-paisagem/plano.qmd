...
| 5º | 08/04 | Escala, padrão e processo: escalas espaço-temporais; fluxos, fragmentação, bordas e resiliência; cartografia temática e interpretação visual. |
| **6º** | **15/04** | **Exercício de delimitação da área de estudo; matriz de evidências e síntese descritivo-interpretativa. 1ª AVALIAÇÃO (TEÓRICA I – individual): fundamentos do conceito de paisagem, abordagens, escala/dinâmica, cartografia e interpretação visual.** |
| 7º | 22/04 | Sensoriamento remoto aplicado I: fundamentos operacionais (resoluções, bandas, composições). |
| 8º | 29/04 | Sensoriamento remoto aplicado I: plataformas avançadas (LiDAR, SAR, drones); exercício de identificação de feições e padrões. |
| — | 06/05 | *Congresso 50+ UEFS – sem conteúdo programático.* |
| 9º | 13/05 | Sensoriamento remoto aplicado II: comparação temporal, detecção de mudanças e trajetórias; produto parcial de mudanças. |
| 10º | 20/05 | Métricas e indicadores de paisagem (heterogeneidade, fragmentação, conectividade); unidades de paisagem e diagnóstico integrado: delimitação, caracterização, pressões, conflitos, vulnerabilidades e potencialidades. |
| 11º | 27/05 | Planejamento territorial e legislação ambiental aplicada à paisagem: diretrizes e prioridades (conservação, conectividade, recuperação). |
| 12º | 03/06 | Zoneamentos aplicados e zoneamento geoecológico: ZEE, ZEEC, ecodinâmica de Tricart; exercício orientado. |
| **13º** | **10/06** | **2ª AVALIAÇÃO (PRÁTICA I – em grupo): *Serious Game/Desafio* (diagnóstico \+ diretrizes \+ justificativa técnica \+ defesa e entrega).** |
| 14º | 17/06 | Atividade de campo: observação sistemática, registros (fotos/croquis), identificação de unidades/processos; organização das evidências. |
| — | 24/06 | *Feriado São João – sem conteúdo programático.* |
| **15º** | **01/07** | **3ª AVALIAÇÃO (PRÁTICA II – individual): entrega do Relatório Técnico de Campo (com evidências e síntese). 4ª AVALIAÇÃO (TEÓRICA II – individual): integração de métodos e tomada de decisão em análise/planejamento da paisagem.** |
| — | 08/07 | *Provas finais.* |
