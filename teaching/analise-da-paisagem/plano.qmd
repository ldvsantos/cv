...
| 8º | 22/04 | Sensoriamento remoto aplicado: fundamentos operacionais (resoluções, bandas, composições); comparação temporal, detecção de mudanças e trajetórias. |
| 9º | 29/04 | Métricas e indicadores de paisagem: heterogeneidade, fragmentação, conectividade, efeito de borda; exercício de interpretação crítica. |
| 10º | 06/05 | Unidades de paisagem e diagnóstico integrado: delimitação, caracterização, pressões, conflitos, vulnerabilidades e potencialidades. |
