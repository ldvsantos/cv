...
| 2º | 11/03 | Apresentação do componente; conceito de paisagem, evolução e distinções (espaço, território, ambiente); paisagem como síntese. |
| 3º | 18/03 | Abordagens integradoras: geossistema, leitura sistêmica; ecologia da paisagem (matriz–mancha–corredor, conectividade). |
| 4º | 25/03 | Escala, padrão e processo: escalas espaço-temporais; fluxos, fragmentação, bordas; resiliência e vulnerabilidade. |
| 5º | 01/04 | Cartografia temática aplicada: leitura integrada (relevo, drenagem, uso/cobertura); exercício de delimitação da área de estudo. |
| 6º | 08/04 | Interpretação visual da paisagem: forma, textura, tonalidade, contexto; matriz de evidências e síntese descritivo-interpretativa. |
| **7º** | **15/04** | **1ª AVALIAÇÃO (TEÓRICA I – individual): fundamentos do conceito de paisagem, abordagens, escala/dinâmica, cartografia e interpretação visual.** |
