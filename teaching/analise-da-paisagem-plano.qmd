...
::: {.text-end .mb-3}
[ Voltar para Análise da Paisagem](analise-da-paisagem.qmd)
:::
...
|  | 04 | 04/03 | Ecologia da paisagem: matrizmanchacorredor; conectividade; implicações para diagnóstico territorial. |
...
* ABSÁBER, Aziz Nacib. **Os domínios de natureza no Brasil: potencialidades paisagísticas**. São Paulo: Ateliê Editorial, 2003\.  
