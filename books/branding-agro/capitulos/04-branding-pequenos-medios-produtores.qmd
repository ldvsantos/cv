...
![No passado, montar uma empresa era difícil, mas uma vez iniciada a demanda excedia a oferta](../img/mercado-antigo-producao.png){#fig-mercado-antigo width="85%"}
...
![Os "diferenciais tradicionais" (qualidade, tecnologia, preço) morreram todos no cenário atual](../img/diferenciais-morreram.png){#fig-diferenciais-morreram width="85%"}
...
![Marca é um conjunto de ativos e passivos vinculados ao nome e símbolo, que somam ou subtraem valor](../img/marca-ativos-passivos.png){#fig-marca-ativos width="85%"}
