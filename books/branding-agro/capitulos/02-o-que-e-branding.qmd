...
![Marca não é logo: o logotipo é apenas uma das manifestações visuais da marca](../img/marca-nao-logo.png){#fig-marca-nao-logo width="85%"}
...
![Marca é reputação, e todo mundo concorda que reputação é importante](../img/marca-reputacao.png){#fig-marca-reputacao width="85%"}
...
![A reputação se constrói sobre o equilíbrio entre entrega concreta e promessa de marca](../img/entrega-vs-promessa.png){#fig-entrega-promessa width="85%"}
...
![O modelo completo de gestão de marca: estratégia, materialização, percepção e modelo de gestão](../img/modelo-gestao-branding.png){#fig-modelo-branding width="85%"}
...
![A marca tem uma dimensão visível (pontos de contato) e uma dimensão invisível (estratégia)](../img/visivel-invisivel.png){#fig-visivel-invisivel width="85%"}
