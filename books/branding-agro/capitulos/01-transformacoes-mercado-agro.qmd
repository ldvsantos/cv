...
![No passado, a demanda excedia a oferta: quem produzia, vendia](../img/demanda-excedia-oferta.png){#fig-demanda-oferta width="85%"}
...
![Quando a barreira de entrada diminui, o mercado se torna agressivo e a oferta supera a demanda](../img/mercado-agressivo.png){#fig-mercado-agressivo width="85%"}
...
![Quando não há diferenciação, a marca se torna invisível em meio à concorrência](../img/voce-so-mais-um.png){#fig-voce-mais-um width="85%"}
...
![O preço baixo não promove escalabilidade nem sustentabilidade da marca](../img/preco-nao-diferencial.png){#fig-preco-diferencial width="85%"}
...
![Diferencial é algo que você tem e seu concorrente tem dificuldade de copiar, e que seu cliente percebe como valor](../img/definicao-diferencial.png){#fig-definicao-diferencial width="85%"}
...
![O diferencial não está mais no que se faz, mas em como e por quê se faz](../img/diferencial-como-faz.png){#fig-diferencial-como-faz width="85%"}
