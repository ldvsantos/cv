...
![Os diferentes tipos de persona: user persona, buyer persona e brand persona atuam em níveis distintos da decisão](../img/tipos-persona.png){#fig-tipos-persona width="85%"}
...
![A gestão de stakeholders determina como a imagem da marca se forma junto a cada público de interesse](../img/stakeholders-imagem.png){#fig-stakeholders-b2b width="85%"}
...
![O modelo de definição de público ideal B2B considera porte, setor, território e perfil do decisor](../img/modelo-b2b-perfil.png){#fig-modelo-b2b width="85%"}
