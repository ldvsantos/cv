...
![Do DNA à construção de valor: a plataforma documenta quem a marca é](../img/dna-construcao-valor.png){#fig-dna-valor width="85%"}
...
![A plataforma integra cultura, estratégia, diferenciais, benefícios e concorrência](../img/plataforma-cultura-estrategia.png){#fig-plataforma-integrada width="85%"}
...
![Cultura, valores, visão de mundo e propósito formam a base estratégica da marca](../img/cultura-valores-proposito.png){#fig-cultura-valores width="85%"}
...
![Definir quem não somos, como não somos e para quem não somos é tão importante quanto definir o que somos](../img/quem-nao-somos.png){#fig-quem-nao-somos width="85%"}
