...
Nos capítulos anteriores, construímos peça por peça os elementos estratégicos da marca:

- **Diferenciação** — O que nos torna únicos (@sec-ideias-diferenciadoras, @sec-suporte-diferenciacao)
- **Benefícios** — O que entregamos além do produto (@sec-beneficios)
- **Público ideal** — Para quem falamos (@sec-publico-ideal)
- **Posicionamento** — O lugar que ocupamos na mente do mercado (@sec-posicionamento)
...
1. Liste 10-15 valores que parecem relevantes
2. Elimine os que são "obrigação" (qualidade, honestidade — todo mundo espera isso)
3. Mantenha 3 a 5 que realmente diferenciam e orientam decisões difíceis

**Teste de valor:** Se o valor nunca gera dilema ou sacrifício, provavelmente é genérico demais. Um valor real implica renúncia — escolher uma coisa em detrimento de outra.

**Exemplo:**

- ❌ "Qualidade" — Esperado, não diferencia
- ✅ "Rastreabilidade radical" — Implica investimento, transparência total, renúncia a atalhos
...
- Que assunto dominaria numa conversa?
...
**Exemplo — Tom de voz para uma cooperativa de mel orgânico:**

- Formalidade: Informal, como uma conversa entre vizinhos
- Humor: Leve, nunca sarcástico
- Entusiasmo: Vibrante quando fala do produto, contido quando fala de dados
- Linguagem: Acessível, sem jargões técnicos desnecessários
- Posição: Parceira do apicultor, não superiora
...
1. **Origem** — De onde viemos, como começou
2. **Desafio** — Qual problema enfrentamos ou enxergamos no setor
3. **Escolha** — O que decidimos fazer diferente
4. **Método** — Como fazemos o que fazemos (o "jeito" da marca)
...
**Perguntas de validação para qualquer decisão:**

1. Esta ação está alinhada com nosso **propósito**?
2. Ela reforça nosso **posicionamento**?
3. Ela é coerente com nossa **personalidade** e **tom de voz**?
4. Ela gera valor para nosso **público ideal**?
5. Ela sustenta nossos **diferenciais**?
