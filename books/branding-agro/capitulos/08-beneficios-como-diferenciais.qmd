...
![A estratégia de marca integra cultura, business e diferenciais como base para gerar valor](../img/cultura-business-diferenciais.png){#fig-cultura-business width="85%"}
...
![Pontos de prova e reforço de posicionamento sustentam a promessa da marca junto ao público](../img/reforco-posicionamento.png){#fig-reforco-pos width="85%"}
