...
Ser o primeiro a fazer algo em um segmento, região ou categoria. O pioneirismo cria uma posição mental difícil de deslocar: a primeira marca a ocupar um espaço na mente do consumidor tende a permanecer lá (Fig. @fig-pioneirismo).

![O pioneirismo como ideia diferenciadora, quando a marca inaugura uma categoria ou segmento](../img/exemplo-pioneirismo.png){#fig-pioneirismo width="85%"}
...
Marcas que se conectam com um passado relevante,  familiar, comunitário ou cultural,  criam associações de confiança, autenticidade e nostalgia. A Granado (Fig. @fig-tradicao) exemplifica como uma marca centenária pode se reinventar sem perder as raízes.

![A Granado como exemplo de diferenciação por tradição, produtos históricos reposicionados com design contemporâneo](../img/exemplo-tradicao-granado.png){#fig-tradicao width="85%"}
...
Ser especialista em uma coisa, e comunicar isso com clareza. Em um mercado de generalistas, o especialista se destaca (Fig. @fig-especializacao).

![A especialização como eixo de diferenciação, focar em um produto ou serviço é o caminho do especialista](../img/exemplo-especializacao.png){#fig-especializacao width="85%"}
...
Como o produto é feito pode ser tão diferenciador quanto o produto em si. Processos artesanais, técnicas proprietárias, métodos sustentáveis ou inovadores criam interesse e valor (Fig. @fig-fabricacao).

![A forma de fabricação como ideia diferenciadora, a ruptura com o massificado cria valor percebido](../img/exemplo-fabricacao.png){#fig-fabricacao width="85%"}
...
Não tentar servir a todos, mas escolher um público muito específico e construir tudo para ele. A abordagem "boutique" (Fig. @fig-boutique) ilustra como a segmentação por premium transforma commodities em produtos de desejo.

![A estratégia boutique como forma de segmentação, transformar o ordinário em premium](../img/exemplo-boutique.png){#fig-boutique width="85%"}
