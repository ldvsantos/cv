...
![Definir o público ajuda a estabelecer conexões e focar esforços de venda](../img/foco-publico.png){#fig-foco-publico width="85%"}
...
![O termo "ideal" remete a buscar um cliente melhor, enquanto "alvo" sugere foco e atenção](../img/alvo-vs-ideal.png){#fig-alvo-ideal width="85%"}
...
![Fatores financeiros e qualitativos para análise do público ideal](../img/fatores-publico.png){#fig-fatores-publico width="85%"}
...
![O Mapa de Empatia é uma ferramenta para compreender o que o público pensa, sente, ouve e faz](../img/mapa-empatia.png){#fig-mapa-empatia width="85%"}
...
![É melhor ser muito relevante para poucos do que um pouco relevante para muitos](../img/relevante-para-poucos.png){#fig-relevante-poucos width="85%"}
