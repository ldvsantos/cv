...
Ao longo dos capítulos anteriores, respondemos às perguntas:

- **O que vendemos?** — Produtos e portfólio (@sec-estrategia-produtos)
- **O que nos diferencia?** — Ideias diferenciadoras e suporte (@sec-ideias-diferenciadoras, @sec-suporte-diferenciacao)
- **O que entregamos de valor?** — Benefícios (@sec-beneficios)
- **Para quem vendemos?** — Público ideal (@sec-publico-ideal)

Posicionamento é a **síntese estratégica** de todas essas respostas. É a definição precisa do lugar que a marca pretende ocupar na mente do público-alvo, de forma:

- **Clara** — O público entende o que a marca é e o que ela oferece
- **Diferenciada** — A marca não se confunde com as concorrentes
- **Relevante** — O posicionamento importa para o público
- **Crível** — A marca pode entregar o que promete
- **Sustentável** — O posicionamento se mantém ao longo do tempo
...
- **Onde há espaço** — Quadrantes pouco ocupados são oportunidades
- **Onde há competição** — Aglomerações indicam saturação
- **Onde você está** — Vs. onde gostaria de estar
...
Uma vez definido, o posicionamento funciona como **filtro para todas as decisões** da marca:
...
- Como devo responder nas redes sociais? → Como a personalidade da marca responderia?
