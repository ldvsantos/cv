...
![O diferencial pode estar na tradição, como o Polvilho Antisséptico Granado, uma das marcas mais antigas do Brasil](../img/exemplo-tradicao-granado-slide.png){#fig-case-tradicao width="85%"}
...
![O diferencial pode estar no pioneirismo, como a Coca-Cola demonstra ao longo de mais de um século de liderança](../img/exemplo-pioneirismo-cocacola.png){#fig-case-pioneirismo width="85%"}
...
![Marcas como Apple e Starbucks construíram diferenciais pela visão de mundo, não apenas pelo produto](../img/exemplo-visao-mundo-apple.png){#fig-case-visao width="85%"}
...
![The Body Shop e Natura construíram suas marcas sobre valores e compromisso ambiental](../img/exemplo-valores-natura.png){#fig-case-valores width="85%"}
...
![Chilli Beans e Havaianas se diferenciaram pela personalidade distintiva de suas marcas](../img/exemplo-personalidade-chillibeans.png){#fig-case-personalidade width="85%"}
