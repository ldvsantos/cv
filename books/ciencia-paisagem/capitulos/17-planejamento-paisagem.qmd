...
::: {#fig-principios-planejamento}
```{mermaid}
%%| fig-width: 9
flowchart TD
    A["Princípios do Planejamento<br>da Paisagem"] --> B["Manter manchas<br>grandes de<br>vegetação nativa"]
    A --> C["Manter conectividade<br>entre manchas<br>(corredores)"]
    A --> D["Proteger zonas<br>ripárias e<br>áreas sensíveis"]
    A --> E["Manter heterogeneidade<br>na matriz<br>produtiva"]
    A --> F["Concentrar usos<br>intensivos em<br>áreas de aptidão"]

    B --> G["Paisagem<br>funcional e<br>resiliente"]
    C --> G
    D --> G
    E --> G
    F --> G
...
```
Cinco princípios fundamentais do planejamento da paisagem e sua convergência para uma paisagem funcional e resiliente.
:::
