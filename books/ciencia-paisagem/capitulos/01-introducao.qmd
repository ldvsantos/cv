...
Essas derivações se acumulam no tempo, criando trajetórias de degradação ou recuperação cuja leitura é possível pela análise da paisagem. Milton Santos [-@santos2006] contribuiu com a distinção operacional entre paisagem (forma, herança material) e espaço (forma somada ao conteúdo social que a anima), distinção aprofundada na @sec-distincoes-operacionais. A formulação miltoniana avança ao tratar o espaço geográfico como conjunto indissociável de sistemas de objetos (a materialidade fixa, herdada de períodos técnicos sucessivos) e sistemas de ações (os fluxos, processos e práticas que animam essa materialidade), de modo que a paisagem é a face visível desse arranjo num dado instante. As *rugosidades*, em Santos [-@santos2006], são justamente os restos de configurações técnicas e produtivas anteriores que persistem no presente como vestígios materiais, condicionando os usos atuais e funcionando como uma espécie de memória inscrita no território, conceito particularmente útil quando se interpreta paisagens herdadas de ciclos econômicos extintos, como antigas zonas canavieiras, áreas mineradas ou faxinais em retração.

Roberto Lobato Corrêa [-@correa1995] complementa esse arcabouço ao sistematizar paisagem, espaço, região, lugar e território como categorias-chave da Geografia que não se equivalem nem se substituem, cada uma recortando o real por um critério distinto e oferecendo, em conjunto, um repertório analítico para leituras multiescalares do território. Paulo César da Costa Gomes [-@gomes1996] acrescenta a dimensão simbólica e cultural da paisagem como condição de visibilidade pública do território, sublinhando que toda forma percebida é mediada por convenções estéticas, jurídicas e políticas que definem o que se torna paisagem reconhecível, dimensão retomada em detalhe na @sec-percepcao.

Jean Paul Metzger [-@metzger2001] articulou uma síntese operacional ao definir ecologia de paisagens como "o estudo da estrutura, função e dinâmica de áreas heterogêneas compostas por ecossistemas interativos", sublinhando que o diferencial da abordagem é tratar explicitamente o efeito da configuração espacial sobre os processos em estudo. Essa formulação, que combina o rigor quantitativo da tradição ecológica com a atenção ao contexto territorial da tradição geográfica, guia o presente livro.
