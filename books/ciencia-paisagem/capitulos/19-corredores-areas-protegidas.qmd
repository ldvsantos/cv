...
::: {#fig-tipos-corredores}
```{mermaid}
%%| fig-width: 9
flowchart TD
    A["Corredor"] --> B["Estrutural<br>(faixa física<br>de habitat)"]
    A --> C["Funcional<br>(rota de<br>deslocamento<br>espécie-específica)"]
    A --> D["De paisagem<br>(região de<br>planejamento<br>multiescalar)"]
    B --> E["Definido por<br>geometria<br>do mapa"]
    C --> F["Definido por<br>comportamento<br>e capacidade<br>de dispersão"]
    D --> G["Definido por<br>política de<br>conservação e<br>restauração"]

    style A fill:#2E7D32,color:#fff
```
Três conceitos de corredor ecológico, distinguindo a perspectiva geométrica (estrutural), biológica (funcional) e de gestão (paisagem).
:::
