...
```{dot}
//| label: fig-derivados-mde
//| fig-cap: "Variáveis topográficas derivadas do MDE e suas aplicações na análise da paisagem."
//| fig-width: 8
digraph {
    rankdir=TB
    bgcolor="transparent"
    ...
    A [label="Modelo Digital\nde Elevação (MDE)", fillcolor="#2E7D32", fontcolor="white", color="#1B5E20", penwidth=1.5]
    B [label="Declividade", fillcolor="#E8F5E9", color="#2E7D32"]
    C [label="Orientação de\nvertentes", fillcolor="#E8F5E9", color="#2E7D32"]
    D [label="Curvatura", fillcolor="#E8F5E9", color="#2E7D32"]
    E [label="Índice topográfico\nde umidade (TWI)", fillcolor="#E8F5E9", color="#2E7D32"]
    F [label="Rede de\ndrenagem", fillcolor="#E8F5E9", color="#2E7D32"]
    G [label="Delimitação\nde bacias", fillcolor="#E8F5E9", color="#2E7D32"]
    H [label="Suscetibilidade\nà erosão", fillcolor="#FFCDD2", color="#C62828"]
    I [label="Áreas\nhidromórficas", fillcolor="#BBDEFB", color="#1565C0"]
    J [label="Conectividade\nhídrica", fillcolor="#BBDEFB", color="#1565C0"]
    K [label="Unidade de\nplanejamento", fillcolor="#FFE0B2", color="#E65100"]
