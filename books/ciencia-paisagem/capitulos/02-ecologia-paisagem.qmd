...
Todo sistema ecológico pode ser caracterizado por cinco propriedades fundamentais:

1. **Estrutura** — organização interna: quais são os componentes e como se arranjam no espaço;
2. **Função** — o que o sistema faz: trocas de energia, matéria e informação entre componentes;
3. **Entradas e saídas** — fluxos que atravessam os limites do sistema (radiação, precipitação, sedimentos, organismos migrantes);
4. **Retroalimentação** — mecanismos pelos quais a saída de um processo influencia sua própria entrada, podendo ser negativa (estabilizadora) ou positiva (amplificadora);
5. **Equilíbrio dinâmico** — estado no qual os fluxos de entrada e saída se compensam ao longo de um período, mantendo a estrutura sem estagnação.
...
Paisagens são, invariavelmente, **sistemas abertos**: recebem energia solar e precipitação, exportam sedimentos e organismos, e são atravessadas por fluxos de matéria e informação que conectam seus elementos internos entre si e com sistemas adjacentes. Essa abertura implica que nenhuma paisagem pode ser compreendida isoladamente: a bacia hidrográfica a montante condiciona os processos a jusante, e a paisagem circundante (a *matriz*) determina os fluxos que chegam a cada fragmento de habitat.
...
::: {#fig-derivacoes layout-ncol=3}
![**Supressão**: desmatamento em padrão de "espinha de peixe" na Amazônia — remoção sistemática da cobertura florestal a partir de estradas vicinais.](../img/desmatamento_espinha_peixe_amazonia.jpg){#fig-supressao}

![**Inserção**: expansão da fronteira agrícola no MATOPIBA — introdução de monoculturas de soja em áreas de Cerrado nativo.](../img/insercao_expansao_matopiba.jpg){#fig-insercao}

![**Alteração funcional**: fragmentação extrema da Mata Atlântica — modificação dos fluxos ecológicos e hidrológicos sem remoção total da cobertura.](../img/supressao_fragmentacao_mata.jpg){#fig-alteracao-funcional}

Exemplos de derivações antropogênicas em paisagens brasileiras: supressão (desmatamento), inserção (fronteira agrícola) e alteração funcional (fragmentação).
:::
...
A **matriz** é o elemento mais extenso e mais conectado da paisagem, que exerce influência dominante sobre os fluxos de energia, matéria e organismos. Três critérios operacionais permitem identificar a matriz: (1) maior área relativa, (2) maior conectividade da cobertura, e (3) maior influência sobre a dinâmica dos demais elementos. Em paisagens agrícolas do Cerrado, por exemplo, a pastagem ou a monocultura de soja tipicamente constitui a matriz, enquanto os remanescentes de vegetação nativa formam as manchas.
...
Os **corredores** são estruturas lineares que conectam manchas de habitat, facilitando o deslocamento de organismos e o fluxo gênico entre populações isoladas. Podem ser corredores de habitat (faixas contínuas de vegetação nativa), corredores ripários (matas ciliares ao longo de cursos d'água) ou *stepping stones* (manchas discretas suficientemente próximas para permitir deslocamento em etapas). A funcionalidade de um corredor depende não apenas de suas dimensões (largura, comprimento), mas de sua qualidade estrutural e compatibilidade com os requerimentos das espécies-alvo.

::: {#fig-elementos-paisagem layout="[[55,45]]" layout-valign="bottom"}
![Efeito de borda: a zona de contato entre a mancha florestal e a matriz agrícola apresenta microclima alterado, maior mortalidade de árvores e invasão de espécies generalistas.](../img/efeito_borda.jpg){#fig-efeito-borda}

![Corredor ecológico conectando fragmentos de Mata Atlântica: estrutura linear que viabiliza o fluxo de organismos entre manchas de habitat isoladas.](../img/corredor_ecologico.jpg){#fig-corredor-ecologico width="80%"}

Elementos da paisagem em ação: o efeito de borda degrada as manchas, enquanto os corredores mitigam o isolamento.
:::
...
A aplicação dos conceitos desenvolvidos neste capítulo ao contexto brasileiro exige o reconhecimento da diversidade de paisagens que caracterizam os diferentes domínios morfoclimáticos. A @fig-biomas-brasileiros ilustra a heterogeneidade fisionômica dessas paisagens — do dossel contínuo da Floresta Amazônica ao mosaico aberto da Caatinga — e permite visualizar os tipos de matrizes, manchas e corredores que cada domínio apresenta.

::: {#fig-biomas-brasileiros layout="[[30,40,30]]" layout-valign="bottom"}
![Floresta Amazônica: dossel contínuo de floresta úmida densa — neste domínio, a floresta constitui a matriz e as áreas desmatadas são as manchas de perturbação.](../img/floresta_amazonica.jpg){#fig-amazonia-paisagem width="80%"}

![Cerrado: formação savânica com mosaico de fisionomias — campo limpo, campo sujo, cerrado *stricto sensu* e cerradão, sob pressão crescente pela expansão agrícola.](../img/cerrado_vegetacao_fixed.jpg){#fig-cerrado-paisagem}

![Caatinga: vegetação xerófila decídua adaptada ao déficit hídrico — fisionomia aberta com alta variação sazonal de cobertura.](../img/caatinga_vegetacao_fixed.jpg){#fig-caatinga-paisagem width="80%"}

Paisagens de três domínios brasileiros: a diversidade fisionômica exige abordagens analíticas adaptadas a cada contexto.
:::

::: {#fig-paisagem-mosaico-processos layout-ncol=2}
![Mosaico de paisagem rural: a heterogeneidade espacial — intercalação de fragmentos florestais, cultivos, pastagens e corpos d'água — é a variável central da ecologia da paisagem.](../img/mosaico_rural.jpg){#fig-mosaico-rural}

![Erosão acelerada em paisagem degradada: quando os limiares sistêmicos são ultrapassados, a retroalimentação positiva (erosão→perda de solo→menor cobertura vegetal→mais erosão) perpetua a degradação.](../img/erosao_solo.jpg){#fig-erosao-paisagem}

Mosaicos rurais e degradação: a estrutura da paisagem determina se os processos operam dentro dos limites de resiliência ou cruzam limiares de degradação.
:::
