...
![Representação do modelo matriz-mancha-corredor: a paisagem como mosaico de três elementos espaciais fundamentais. A matriz (fundo dominante) envolve manchas de habitat (fragmentos) conectadas por corredores lineares. Elaboração própria.](../img/matriz_mancha_corredor.jpg){#fig-matriz-mancha-corredor fig-align="center" width="85%"}
...
![Efeito de borda: a zona de contato entre a mancha florestal e a matriz agrícola apresenta microclima alterado, maior mortalidade de árvores e invasão de espécies generalistas. Fonte: Wikimedia Commons. Domínio público.](../img/efeito_borda.jpg){#fig-efeito-borda fig-align="center" width="80%"}
...
![Corredor ecológico (mata ciliar) ao longo de curso d'água conectando fragmentos florestais: estrutura linear que viabiliza o fluxo de organismos entre manchas de habitat isoladas pela matriz agrícola. Elaboração própria.](../img/corredor_ecologico.jpg){#fig-corredor-ecologico fig-align="center" width="80%"}
...
![Floresta Amazônica, dossel contínuo de floresta úmida densa. Neste domínio, a floresta constitui a matriz e as áreas desmatadas são as manchas de perturbação. Fonte: Wikimedia Commons, CC BY 2.0.](../img/floresta_amazonica.jpg){#fig-amazonia-paisagem fig-align="center" width="80%"}
...
![Cerrado, formação savânica com mosaico de fisionomias (campo limpo, campo sujo, cerrado *stricto sensu* e cerradão), sob pressão crescente pela expansão agrícola. Fonte: Wikimedia Commons, CC BY-SA 4.0.](../img/cerrado_vegetacao_fixed.jpg){#fig-cerrado-paisagem fig-align="center" width="80%"}
...
![Mosaico de paisagem rural: a heterogeneidade espacial (intercalação de fragmentos florestais, cultivos, pastagens e corpos d'água) é a variável central da ecologia da paisagem. Elaboração própria.](../img/mosaico_rural.jpg){#fig-mosaico-rural fig-align="center" width="80%"}
