...
::: {#fig-servicos-categorias}
```{mermaid}
%%| fig-width: 9
flowchart TD
    A["Estrutura da Paisagem<br>(composição e configuração)"] --> B["Serviços de<br>Provisão<br>alimentos, água,<br>madeira, fibras"]
    A --> C["Serviços de<br>Regulação<br>clima, água,<br>erosão, polinização"]
    A --> D["Serviços<br>Culturais<br>recreação, estética,<br>identidade"]
    A --> E["Serviços de<br>Suporte<br>solo, ciclagem,<br>biodiversidade"]
    E --> B
    E --> C
    E --> D
    B --> F["Bem-estar<br>humano"]
    C --> F
    D --> F
...
```
Relação entre a estrutura da paisagem, as quatro categorias de serviços ecossistêmicos e o bem-estar humano. Os serviços de suporte sustentam as três demais categorias.
:::
