...
![Estágios progressivos da fragmentação florestal, da floresta contínua a manchas isoladas: a redução de área núcleo e o aumento de borda intensificam-se de forma não-linear nos estágios avançados, amplificando efeitos de isolamento e degradação de habitat.](../img/estagios_fragmentacao.jpg){#fig-estagios-fragmentacao fig-align="center" width="85%"}
