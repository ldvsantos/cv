...
```{dot}
//| label: fig-modelos-biodiversidade
...
digraph {
    ...
    subgraph cluster_classico {
        label="Modelo Clássico"
        fontname="Helvetica"
        fontsize=12
        style="rounded,dashed"
        color="#90A4AE"

        A [label="Mancha\n(habitat)", fillcolor="#228B22", fontcolor="white", color="#1B5E20"]
        B [label="Matriz\n(não-habitat\nhomogêneo)", fillcolor="#F5DEB3", color="#8D6E63"]
        C [label="Biodiversidade =\nf(área, isolamento)", fillcolor="#BBDEFB", color="#1565C0"]

        A -> B [dir=none]
        A -> C
    }

    subgraph cluster_heterogeneidade {
        label="Modelo de Heterogeneidade"
        fontname="Helvetica"
        fontsize=12
        style="rounded,dashed"
        color="#90A4AE"

        D [label="Tipo 1", fillcolor="#C8E6C9", color="#2E7D32"]
        E [label="Tipo 2", fillcolor="#FFE0B2", color="#E65100"]
        F [label="Tipo 3", fillcolor="#E1BEE7", color="#6A1B9A"]
        G [label="Tipo 4", fillcolor="#BBDEFB", color="#1565C0"]
        H [label="Biodiversidade =\nf(heterogeneidade\ndo mosaico)", fillcolor="#A5D6A7", color="#1B5E20"]
