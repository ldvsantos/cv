...
![Carta de cores de Munsell — ferramenta padrão para determinação objetiva da cor do solo em campo, utilizada na descrição morfológica de horizontes.](../img/cores_munsell.jpg){#fig-munsell fig-alt="Carta de cores de Munsell para descrição de solos" width="70%"}
...
A @tbl-ks apresenta valores típicos de $K_s$ para as principais classes de solos tropicais brasileiros, obtidos a partir de compilação de ensaios publicados na literatura nacional. Esses valores orientam o dimensionamento preliminar de geodrenos (ver @sec-biotexteis), bacias de captação (ver @sec-bacias-captacao) e canaletas verdes (ver @sec-canaleta-verde), devendo ser confirmados por ensaios in situ na fase de projeto executivo.
...
| Neossolo Quartzarênico | 200–800 | Extremamente permeável | Baixa retenção hídrica, Bio-SAP recomendado (@sec-biopolimeros) |

: Condutividade hidráulica saturada típica para solos tropicais brasileiros e implicações para bioengenharia. {#tbl-ks .striped .hover}
...
![Mapa pedológico — distribuição espacial das classes de solo em uma área de projeto, ferramenta essencial para o planejamento de intervenções de bioengenharia diferenciadas por tipo de solo.](../img/mapa_pedologico.jpg){#fig-mapa-pedologico fig-alt="Mapa pedológico com distribuição das classes de solo" width="80%"}
