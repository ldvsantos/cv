...
::: {.callout-note}
## ClORPT
O acrônimo **ClORPT** é uma forma didática de memorizar os fatores de formação do solo: **Cl**ima, **O**rganismos, **R**elevo, **P**arent material (material de origem) e **T**empo. Nos trópicos, o clima (especialmente a precipitação) e o tempo são os fatores dominantes, o que explica o intemperismo avançado mesmo sobre diferentes tipos de rocha.
:::
