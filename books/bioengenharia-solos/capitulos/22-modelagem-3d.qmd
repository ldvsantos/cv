...
![Fluxograma do protocolo de fotogrametria SfM para modelagem de sistemas radiculares: da captura fotográfica ao cálculo do Fator de Segurança.](img/fluxo_sfm_raizes.png){#fig-fluxo-sfm fig-alt="Fluxograma do protocolo de fotogrametria SfM" width="90%"}
