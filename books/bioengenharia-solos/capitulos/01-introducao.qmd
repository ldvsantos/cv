...
```{dot}
//| label: fig-transicao
//| fig-cap: "Esquema conceitual da transição entre a função mecânica dos materiais construtivos e a função ecológica do sistema radicular."
//| fig-width: 7
digraph {
    rankdir=LR
    bgcolor="transparent"
    ...
    A [label="Ano 0–4\nResistência mecânica\ndo material", fillcolor="#BBDEFB", color="#1565C0"]
    B [label="Ano 1–5\nEstabelecimento\nradicular", fillcolor="#C8E6C9", color="#2E7D32"]
    C [label="Ano 4–10\nSolo\nauto-sustentável", fillcolor="#A5D6A7", color="#1B5E20"]

    A -> B [label="  Transição  ", style=bold, color="#2E7D32"]
    B -> C [label="  Consolidação  ", style=bold, color="#1B5E20"]
}
```
