...
![Distribuição da precipitação — série pluviométrica e curvas IDF utilizadas para determinação da precipitação de projeto ($P$) no dimensionamento de bacias de captação.](../img/precipitacao.png){#fig-precipitacao fig-alt="Gráfico de distribuição da precipitação" width="80%"}
