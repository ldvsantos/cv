...
![Dispositivo de coluna drenante — esquema construtivo do dreno subsuperficial biodegradável com camadas de materiais vegetais envolvidos em geotêxtil.](../img/dispositivo_coluna.png){#fig-dispositivo-coluna fig-alt="Esquema de dispositivo de coluna drenante biodegradável" width="75%"}
...
![Arranjo em espinha de peixe (*herringbone*) — disposição espacial dos feixes vivos em curvas de nível combinados com drenos verdes nos talvegues, formando o sistema integrado de manejo de enxurrada.](../img/espinha_peixe.png){#fig-espinha-peixe fig-alt="Diagrama de arranjo em espinha de peixe combinando feixes e drenos" width="80%"}
